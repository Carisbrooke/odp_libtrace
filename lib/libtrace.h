...
enum base_format_t {
	...
	TRACE_FORMAT_ODP          =26,  /** Open Data Plane develop Kit format */
...
typedef enum {
	...
	/** ODP support */
	TRACE_RT_DATA_ODP=TRACE_RT_DATA_SIMPLE+TRACE_FORMAT_ODP,
	...
	TRACE_RT_DATA_KAFKA=TRACE_RT_DATA_SIMPLE+TRACE_FORMAT_KAFKA,
	TRACE_RT_DATA_ACCE=TRACE_RT_DATA_SIMPLE+TRACE_FORMAT_ACCE,
...
#define VLAN_NOT_FOUND 0xFF

/** constant to check if a mpls label was found */
#define MPLS_NOT_FOUND 0xFFFF
 ...
 * Note, this must be kept in sync with TRACE_OPTION_COMPRESSTYPE_* numbers in wandio.h
 */ 
typedef enum {
	...
	TRACE_OPTION_COMPRESSTYPE_LZ4  = 6,  /**< lz4 Compression */
        TRACE_OPTION_COMPRESSTYPE_HWZLIB  = 7, /** HWZLIB compression */
        // BLOSC TYPES OF COMPRESSION       
        TRACE_OPTION_COMPRESSTYPE_BLOSC_BLOSCLZ   = 8,
        TRACE_OPTION_COMPRESSTYPE_BLOSC_LZ4       = 9,
        TRACE_OPTION_COMPRESSTYPE_BLOSC_LZ4HC     = 10,
        TRACE_OPTION_COMPRESSTYPE_BLOSC_SNAPPY    = 11,
        TRACE_OPTION_COMPRESSTYPE_BLOSC_ZLIB      = 12,
        TRACE_OPTION_COMPRESSTYPE_BLOSC_ZSTD      = 13,
        /** All supported methods - used as a bitmask */
        TRACE_OPTION_COMPRESSTYPE_LAST    = 14         
